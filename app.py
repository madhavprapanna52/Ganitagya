...
def chat():
    ...
    try:
        ...
        #TODO move video to static and then load it here

        return jsonify({
            "response": response.text,
            "video_url": "static/MathVideoScene.mp4",  # Add video generation logic here
            "question": message
        })
...
def serve_generated_video(filename):
    ...
    #TODO Make routing of taking those video path to render from the front end part
